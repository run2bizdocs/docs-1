...
-   **2 - Navegación en aplicaciones**: acceso a los 16 procesos certificados de
...
-   **3**: posee todos los 16 procesos certificados de la Plataforma CITSmart;
...
[Personalizar el panel de administración (Smart Decision)](/es-es/citsmart-platform-9/additional-features/reports/create/dashboard-customize-management-panel-smart-decision.html)
