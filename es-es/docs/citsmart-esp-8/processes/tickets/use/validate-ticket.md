...
[Configurar permissão de acesso do gerenciamento de requisições/incidentes](/en-us/citsmart-esp-8/processes/tickets/configuration/configure-access-permission-ticket.html)
