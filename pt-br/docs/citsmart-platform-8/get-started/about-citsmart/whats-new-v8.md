...
![Novo acesso do CITSmart](media/77fd754a5b667e3e2d5f5a2f2963ddf9.png)
...
![Centros de Experiência](media/b3f8b1578f498d74c13b9e3797ce265a.png)
...
![Criação de CE](media/image001.png)

![Visualização de um CE](media/db062d281d82abfa78db1df0faecd0bf.png)
...
![Portfólios do usuário logado](media/2b7bd70982826c5495cd89a5dfb80bad.png)
...
![b-Linha do Tempo do Ticket](media/220a052a9327a9e9449c2a944197c0fb.png)

![c-Notas para o Atendente](media/8932518c8dc4682676b26be17ca8790f.png)

![d-Chat com o Atendente](media/ba9bb6e90129912b1ae133d0d48a0c38.png)
...
![Menu de Opções do CITSmart](media/1001e25892abe90fac65435e1046ce70.png)
...
![Acesso Rápido](media/872ec514a50a5df0fc1c52dbe939726a.png)
...
![b-Seleção de portfólio](media/cc35b86d242b00d9cd5889f8bc00e9de.png)

![c-Fluxo do atendimento](media/627e79b1f81043ca8ce213488105218b.png)
...
![i-Solução de contorno](media/497f2cd45381eecb91a61e7ce5293534.png)

![Detalhamento da Solução de Contorno](media/7c1f08ad6a57bf48f962c3697d9e74ac.png)
...
![b-Simple-Sprints](media/bf1799ff10f7a0ffd777796cb6942783.png)

![c-Simple-Kanbans](media/bf1799ff10f7a0ffd777796cb6942783.png)
...
![Detalhamento da Tarefa](media/567ad02f39ebfa223c1670d3f51225bd.png)
...
![Gerenciamento de problemas](media/2b3616dc46702da0d7db949534b570e5.png)
...
Para facilitar a organização e a classificação dos registros de mudança, o CITSmart passou a utilizar o conceito de Portfólio de Mudanças, permitindo pré-configurar templates com fluxo de atendimento, calendário, grupos responsáveis etc.
...
Também é possível vincular aos templates os formulários de análise ágil de risco. Cada template de mudança poderá utilizar um formulário com perguntas e pesos. De acordo com a análise, um gráfico de risco é apresentado. Veja abaixo:

![](media/5e75c4a2e9b58289e8904df5a6b1db77.png)

O Planejamento, Reversão e a Revisão e Fechamento da Mudança agora contam com a gestão ágil do Simple, assim várias equipes podem executar tarefas de forma rápida, transparente e colaborativa.
...
O Gerenciamento de Liberação e Implantação também passou por evoluções. O painel de listagem segue o mesmo padrão apresentado nos processos anteriores.

![](media/2156515c0b739dfea8febf3559ed4e69.png)

No menu lateral foi estruturado uma sequência de passos para facilitar o acompanhamento da liberação.

![](media/93fd32b7239e8ea2ecb21059d92c28b9.png)

As mudanças empacotadas para liberação são apresentadas na mesma tela, facilitando o acompanhamento.

![](media/ab0edbc9c5f9865b47c82508d1afc0cd.png)

O Planejamento e a Implantação agora contam com a Gestão Ágil do Simple, facilitando o envolvimento e a colaboração de várias equipes

![](media/968d2eeb13fb27b551c56c235bc9d7dc.png)

### Business Intelligence

Um dos módulos opcionais nesta nova versão é o Smart Analytics que permite o uso da estrutura de BI do Saiku Community para análise de dados de Tickets, Mudanças, Releases etc.

![](media/1ccae7bf7ce5685e45f05ecc63d89a44.png)

Há várias visões de gráficos e tabelas, com a possibilidade de filtros e exportação para csv e pdf.
...
[Saiba mais sobre o App FS.](https://docs.citsmart.com/pt-br/citsmart-platform-8/additional-features/mobile-and-field-service/apps/citsmart-field-service-manual.html)
