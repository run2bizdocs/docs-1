...
Após a liberação do ambiente Anuva, acesse o ambiente de configuração da Anuva através do link disponibilizado pela CITSmart. (http://<Sua-Instância>.anuvaassistant.com).
