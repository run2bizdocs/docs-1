...
-----------------------
    ...
    A instalação do CITSmart Enterprise requer sistema operacional GNU/Linux
    com kernel igual ou superior ao 3.10.

    Recomendamos Red Hat, CentOS, Debian ou Ubuntu.

1- Para execução do CITSmart Enterprise, baixaremos os pacotes necessários conforme
...
2- O download do Java JDK8u172 diretamente do repositório oficial
jdk-8u172-linux-x64.tar.gz  
3- Download do pacote diretamente do repositório oficial através do link
...
4- Download do módulo jbdc para o postgresql:
...
2- Observe o retorno dos comandos analisando a correta execução.
...
1-Instale os pacotes unzip e lsof.

2-Descomprima o JAVA e Solr para /opt/
...
3-Crie um usuário para execução do Solr com shell falso e com permissão no
...
4-Descomprima o arquivo para configurações da base de conhecimento e execute a
...
5-Observe que o retorno do comando deve ser algo como no exemplo abaixo.
