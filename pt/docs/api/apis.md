...
<table width='100%'>
	<tr>
		<td><a href='#project-layout' width="30%" ><img src='/img/bn-api.png'></a> </td>
		<td class='md-typeset justificar' width="70%" > An API - Application Programming Interface is a tool set that programmers can use ion creation a software. A good API will have clear and concise commands that a programmer can use and reuse, so they don't have to build everything over again. CUItilities programs, a set of software routines or a complete integrated set of software utilities that are used to develop and maintain applications and databases, all providing the tools and libraries for creating menus, dialog boxes, fonts and icons. It  linking the application to libraries of software routines and to the operating environment </td>
	</tr>
</table>
