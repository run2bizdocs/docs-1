...
>   **NOTE: the amount of requests listed, by page, is regarding the amount set
...
>   **NOTE: when the user wants to analysis all requests, setting the value to
...
>   **NOTE: the field “finish date” will be used to filter the period of the
...
>   **NOTE: the system will present all unities and services actives, regarding
